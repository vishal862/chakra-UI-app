...
const Videos = () => {
  ...
  return <Stack direction={["column","row"]} h={"100vh"}>
    <VStack w={"full"}>
        ...
        <VStack alignItems={"flexstart"} p={8} w={"full"} overflow={'auto'}>
            <Heading>
                Sample Video 1
            </Heading>
            <Text>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Distinctio voluptatibus nesciunt asperiores, itaque natus laudantium alias sequi inventore illum, fugiat unde id. Deleniti, explicabo quidem. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellendus itaque, fugiat animi quam commodi optio voluptatem iure magni excepturi.
            </Text>
        </VStack>
        ...
        overflow={'auto'}>
            {
                videosArr.map((item,index)=>(
                    <Button variant={"ghost"} colorScheme='purple' p={5} onClick={()=> setVideoSrc(item)}>
                        Lecture {index+1}
                    </Button>
                ))
            }
